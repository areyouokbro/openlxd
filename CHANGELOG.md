...
## [3.4.0] - 2026-01-04 - 完整 UI 更新

### 🎉 重大更新

完成了所有计划中的 Web 管理功能，新增日志查看、容器详情和终端控制台。功能完整度达到 95%。
...
- `web/static/terminal.js` - 终端控制台模块 (150 行)
- `internal/api/logs.go` - 日志和详情 API (150 行)
- `COMPLETE_UI.md` - 完整 UI 更新说明

### 🔧 修改文件

- `web/templates/dashboard.html` - 添加日志、详情、终端标签页 (+170 行)
- `web/static/dashboard.js` - 更新标签页切换逻辑
- `internal/models/container.go` - 添加 OperationLog 模型
